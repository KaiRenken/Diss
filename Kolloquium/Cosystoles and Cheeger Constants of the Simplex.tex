...
Deleting the one edge in the middle will give a disconnected graph, consisting of two connected components, each of them consisting of 6 vertices.

\pause

The Cheeger constant of this graph is $\frac{1}{6}$.
}
