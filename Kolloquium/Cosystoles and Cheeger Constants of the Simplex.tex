...
\section{Cosystoles and generalized Cheeger constants of the simplex}
...
\]
\pause
Question: Is it possible to partition the summands of the shorter sums, such that each part sums up to one of the summands of the longer sums?\\
\pause
